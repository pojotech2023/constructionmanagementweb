...
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-8 offset-lg-1">
            <h3 class="pb-4 mt-3">Generate Purchase Bill</h3>
        </div>
        <div class="col-lg-2 text-end pb-4">
            <a href="{{ route('purchaseBill.history', $site->id) }}" class="btn btn-outline-primary">🕘 Bill History</a>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-11">
                ...
                <form id="purchaseBillForm" action="{{ route('purchaseBill.add') }}" method="POST" class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 text-center">
                            <button type="button" class="btn btn-outline-danger purchase-bill-action-btn" id="resetFormButton" data-bs-toggle="modal" data-bs-target="#resetFormModal">Reset</button>
                        </div>
                    </div>
                </form>
