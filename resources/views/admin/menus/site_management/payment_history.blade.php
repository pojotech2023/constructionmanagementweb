                ...
                <div class="card-body">
                    <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-3">
                        ...
                        <div class="fw-bold text-primary">
                            Contract Value: {{ number_format($budgetAmount, 2) }}
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="payment_mode" id="edit_payment_mode" required>
                                ...
                                <option value="Cash-B" {{ old('payment_mode') == 'Cash-B' ? 'selected' : '' }}>Cash-B</option>
                            </select>
                            @error('payment_mode')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.editPaymentBtn').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    form.action = "{{ route('site.payment.update', ':id') }}".replace(':id', id);
            ...
            document.getElementById('editPaymentForm').addEventListener('submit', function() {
                ...
                if (idField.value) {
                    this.action = "{{ route('site.payment.update', ':id') }}".replace(':id', idField.value);
                }
            });
            ...
            document.querySelectorAll('.deletePaymentBtn').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    form.action = "{{ route('site.payment.delete', ':id') }}".replace(':id', id);
                });
            });
        });
    </script>
