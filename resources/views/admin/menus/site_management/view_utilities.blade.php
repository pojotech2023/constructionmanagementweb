                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#utilityExportModal">
                                Export
                            </button>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <button type="button" class="btn btn-link btn-primary btn-lg editUtilityBtn"
                                                                data-id="{{ $utility->id }}"
                                                                data-amount="{{ $utility->amount }}"
                                                                data-remarks="{{ $utility->remarks }}"
                                                                data-date="{{ \Carbon\Carbon::parse($utility->created_at)->format('Y-m-d') }}"
                                                                data-image="{{ $utility->image }}"
                                                                data-bs-toggle="modal" data-bs-target="#editUtilityModal">
                                                                <i class="fa fa-edit"></i>
                                                            </button>
                                                            <button type="button" class="btn btn-link btn-danger deleteUtilityBtn" data-id="{{ $utility->id }}" data-bs-toggle="modal" data-bs-target="#deleteUtilityModal">
                    ...
                    <div class="modal fade" id="utilityExportModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <form method="GET" action="{{ url('/admin/site-utilities/' . $siteId . '/export') }}" class="js-export-modal-form">
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            document.querySelectorAll('.editUtilityBtn').forEach(function (btn) {
                                btn.addEventListener('click', function () {
                                    ...
                                    form.action = '/admin/utilities-update/' + id;
                            ...
                            // Delete utility populate
                            document.querySelectorAll('.deleteUtilityBtn').forEach(function (btn) {
                                btn.addEventListener('click', function () {
                                    var id = this.getAttribute('data-id');
                                    var form = document.getElementById('deleteUtilityForm');
                                    form.action = '/admin/utilities-delete/' + id;
                                });
                            });
                        });
                    </script>
