...
@section('content')
    <div class="container">
        <div class="page-inner">
            <div class="row mb-3">
                <div class="col-12">
                    <h3 class="text-center fw-bold pb-2 mb-0">Inward {{ ucfirst($materialType) }} Order</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <form id="requestForm" action="{{ route('add.order') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 align-items-center">
                            <label for="vendor_gstin" class="col-sm-4 col-md-3 col-lg-2 col-form-label fw-bold text-sm-end">Vendor GST</label>
                            <div class="col-sm-8 col-md-8 col-lg-6 form-input-wrap">
