...
class OtherUtilitiesSubExport implements FromCollection, WithHeadings, WithMapping, WithCustomStartCell, WithEvents
{
    protected $siteId;
    protected $fromDate;
    protected $toDate;
    ...
    {
        $query = OtherUtilitiesSub::where('site_id', $this->siteId);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Sub-Utilities Report - ' . $this->siteName);
